...
namespace Utility
{
	...
	public:
		...
		static constexpr uint32_t Get1DIndex(uint2 index, uint32_t width)
		{
		...
		static constexpr uint32_t Get1DIndex(uint3 index, uint32_t width, uint32_t sliceSize)
		{
		...
		static constexpr uint2 Get2DIndex(uint32_t index, uint32_t width)
		{
			uint2 index2D{};
		...
		static constexpr uint3 Get3DIndex(uint32_t index, uint32_t width, uint32_t sliceSize)
		{
			uint3 index3D{};
